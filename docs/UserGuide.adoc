...
Adds a temporary person to the address book which will be deleted the next time address book opens +
Format: `add n/NAME p/PHONE_NUMBER e/EMAIL a/ADDRESS t/temporary [t/TAG]...`

[TIP]
User can supply the temporary tag before or after any other tag

Examples:

* `add n/Betsy Crowe t/friend e/betsycrowe@example.com a/Newgate Prison p/1234567 t/temporary t/criminal`

=== Adding a picture: `GUI button`

Adds a person to the address book +
Format: `click on '+' button after adding the person into the addressbook`
...
=== Sorting the list of persons : `sorting`

Sorts the list of persons according to the sorting criteria provided. +
