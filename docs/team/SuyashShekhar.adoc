...
=== 1. UI Enhancement: `Designed and Built UI`
...
---
#Start of Styling Extract [from: Developer Guide]#

include::../DeveloperGuide.adoc[tag=styling]

#End of Styling Extract#

---


=== 2. Enhancement: `Swap Room Command`
...
Requests to swap rooms with other residents are very common in residential colleges and halls. The hostel management often finds it difficult to accomodate such a request because of the logistics that goes behind switching the rooms for two people. So, ResidentBook offers a simple command to execute swap rooms.
...
=== 4. Enhancement: `Add Event Command`
...
=== 5. Enhancement: `Delete Event Command`
...
=== 6. Enhancement: `Switch Tab Command`
...
=== 7. Enhancement: `Implemented EventsBook`
...
* A hostel management staff needs to keep track of all the events which go on in the hostel for various reasons:
* To keep track of room bookings and usage
* Send out emails and notifications for upcoming events to everyone in the hostel
* Look out for potential clash of events and prepare in advance
* Organise hostel events when students do not have many other events so that all events are evenly spaced out
...
* Wrote python script to generate GitHub issues and shared with on the CS2103 Slack channel
