...
The import mechanism is essentially adding multiple contacts to the address book automatically by referencing a xml file.
...
image::ImportCommandActivityDiagram.png[width="200"]
