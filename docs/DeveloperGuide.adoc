...
* Allow tentative events for which the `Location` or `Datetime have not yet been finalised.
...
* `switch` should be able to detect the current tab and switch without taking in any arguments.
